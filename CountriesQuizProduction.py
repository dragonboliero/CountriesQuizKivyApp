...
class CountriesQuiz(MDApp):
    ...
    def fill_hiscores(self):
        ...
        self.root.get_screen('HSScreen').ids.usr3.text = current_scores['capitals'][2][0]
        self.root.get_screen('HSScreen').ids.usr4.text = current_scores['capitals'][3][0]
        self.root.get_screen('HSScreen').ids.usr5.text = current_scores['capitals'][4][0]
        self.root.get_screen('HSScreen').ids.usr6.text = current_scores['capitals'][5][0]
        self.root.get_screen('HSScreen').ids.usr7.text = current_scores['capitals'][6][0]
        ...
        self.root.get_screen('HSScreen').ids.ca_pos4.text = current_scores['capitals'][3][1]
        self.root.get_screen('HSScreen').ids.ca_pos5.text = current_scores['capitals'][4][1]
        self.root.get_screen('HSScreen').ids.ca_pos6.text = current_scores['capitals'][5][1]
        self.root.get_screen('HSScreen').ids.ca_pos7.text = current_scores['capitals'][6][1]
        ...
        self.root.get_screen('HSScreen').ids.f_usr3.text = current_scores['flags'][2][0]
        self.root.get_screen('HSScreen').ids.f_usr4.text = current_scores['flags'][3][0]
        self.root.get_screen('HSScreen').ids.f_usr5.text = current_scores['flags'][4][0]
        self.root.get_screen('HSScreen').ids.f_usr6.text = current_scores['flags'][5][0]
        self.root.get_screen('HSScreen').ids.f_usr7.text = current_scores['flags'][6][0]
        ...
        self.root.get_screen('HSScreen').ids.f_pos4.text = current_scores['flags'][3][1]
        self.root.get_screen('HSScreen').ids.f_pos5.text = current_scores['flags'][4][1]
        self.root.get_screen('HSScreen').ids.f_pos6.text = current_scores['flags'][5][1]
        self.root.get_screen('HSScreen').ids.f_pos7.text = current_scores['flags'][6][1]
        ...
        self.root.get_screen('HSScreen').ids.co_usr3.text = current_scores['continents'][2][0]
        self.root.get_screen('HSScreen').ids.co_usr4.text = current_scores['continents'][3][0]
        self.root.get_screen('HSScreen').ids.co_usr5.text = current_scores['continents'][4][0]
        self.root.get_screen('HSScreen').ids.co_usr6.text = current_scores['continents'][5][0]
        self.root.get_screen('HSScreen').ids.co_usr7.text = current_scores['continents'][6][0]
        ...
        self.root.get_screen('HSScreen').ids.co_pos4.text = current_scores['continents'][3][1]
        self.root.get_screen('HSScreen').ids.co_pos5.text = current_scores['continents'][4][1]
        self.root.get_screen('HSScreen').ids.co_pos6.text = current_scores['continents'][5][1]
        self.root.get_screen('HSScreen').ids.co_pos7.text = current_scores['continents'][6][1]
