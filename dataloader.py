...
def get_global_hiscores():
    ...
    global_scores_dictionary["global_capitals"] = capitals_global_scores
    global_scores_dictionary["global_flags"] = flags_global_scores
    global_scores_dictionary["global_continents"] = continents_global_scores
